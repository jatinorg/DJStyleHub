        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-amber-900/40 text-xs">
          ...
          <div className="lg:col-span-4 space-y-3">
            ...
            <div className="flex items-center gap-3 pt-3 text-neutral-400">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 hover:bg-white/15 hover:text-white rounded-full transition" aria-label="Instagram">
              ...
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 hover:bg-white/15 hover:text-white rounded-full transition" aria-label="YouTube">
                <svg className="w-4 h-4 fill-currentColor" viewBox="0 0 24 24">
